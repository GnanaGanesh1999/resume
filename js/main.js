(function() {
    ...
    function uiScrollDown() {
        ...
        const target = document.querySelector('.js-ui-scroll-button1');

        var destination;
        // console.log(target.classList.contains('scroll1'));

        // if (target.classList.contains('scroll1')) {
        destination = document.querySelector('section:nth-of-type(2)');
        // } else if (target.classList.contains('scroll2')) {
        // destination = document.querySelector('section:nth-of-type(3)');
        // }
        if (!target) return;
        ...
        // const target = document.querySelector('.js-ui-scroll-button2');
